set -gx CONDA_EXE (cygpath "E:/Newfolder\Scripts\conda.exe")
set _CONDA_ROOT (cygpath "E:/Newfolder")
set _CONDA_EXE (cygpath "E:/Newfolder\Scripts\conda.exe")
set -gx CONDA_PYTHON_EXE (cygpath "E:/Newfolder\python.exe")
